package com.unleashed.pyramidalbitcoin.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("pyramidalbitcoin");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("pyramidalbitcoin");
        ...
        config.getMapConfigs().put("com.unleashed.pyramidalbitcoin.domain.*", initializeDomainMapConfig(jHipsterProperties));
